...
describe('InfluenceMatrix', () => {
  ...
  beforeEach(() => {
    ...
    factorA = new InfluencingFactor('FactorA', "FactorA factors in A", Variable.ControlVaraible, InfluencingArea.Handel);
    factorB = new InfluencingFactor('FactorB', "FactorB factors in B", Variable.ControlVaraible, InfluencingArea.Ökonomie);
    factorC = new InfluencingFactor('FactorC', "FactorC factors in C", Variable.EnvironmentVariable, InfluencingArea.Gesellschaft);
  });
  ...
  test('should return undefined for active sum if factor does not exist', () => {
    const activeSum = influenceMatrix.getActiveSum(new InfluencingFactor('NonExistingFactor', 'NonExistingFactor factors nothing in', Variable.ControlVaraible, InfluencingArea.Gesellschaft));
  ...
  test('should return undefined for passive sum if factor does not exist', () => {
    const passiveSum = influenceMatrix.getPassiveSum(new InfluencingFactor('NonExistingFactor', 'NonExistingFactor factors nothing in', Variable.ControlVaraible, InfluencingArea.Gesellschaft));
  ...
  test('should return undefined for impulse index if active sum is undefined', () => {
    const impulseIndex = influenceMatrix.calcImpulsIndex(new InfluencingFactor('NonExistingFactor', 'NonExistingFactor factors nothing in', Variable.ControlVaraible, InfluencingArea.Gesellschaft));
  ...
  test('should return undefined for dynamic index if active sum is undefined', () => {
    const dynamicIndex = influenceMatrix.calcDynamicIndex(new InfluencingFactor('NonExistingFactor', 'NonExistingFactor factors nothing in', Variable.ControlVaraible, InfluencingArea.Gesellschaft));
